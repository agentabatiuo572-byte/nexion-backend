package ffdd.compliance.config;
...
public class OutboxRocketConfig {
    ...
    public DefaultMQProducer complianceOutboxRocketProducer(
            @Value("${nexion.outbox.rocketmq.name-server:127.0.0.1:9876}") String nameServer,
            @Value("${nexion.outbox.rocketmq.compliance-producer-group:nexion-compliance-outbox}")
