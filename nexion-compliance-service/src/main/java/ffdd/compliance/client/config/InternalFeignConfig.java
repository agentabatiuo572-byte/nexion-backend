package ffdd.compliance.client.config;
...
public class InternalFeignConfig {
    ...
    public RequestInterceptor internalServiceAuthInterceptor(
        ...
        return template -> {
            ...
            template.header(AuthHeaders.USERNAME, "nexion-compliance-service");
            template.header(AuthHeaders.AUTHORITIES, "PERM_WALLET_WRITE,PERM_WALLET_READ,PERM_COMPLIANCE_WRITE");
        };
    }
}
