...
public interface SystemHelpService {
    ...
    PageResult<HelpArticleResponse> page(String query, Integer status, long pageNum, long pageSize);

    HelpArticleResponse getById(Long id);
    ...
    HelpArticleResponse archive(Long id);
}
