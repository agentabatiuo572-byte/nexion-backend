...
import ffdd.opsconsole.team.application.AppTeamQuotaService;
...
public class AppTeamQuotaController {
    private final AppTeamQuotaService service;

    @GetMapping("/quota")
    public ApiResult<Map<String, Object>> quota(Authentication authentication) {
