...
public class OpsI18nLearningController {
    ...
    public ApiResult<I18nLearningOverview> overview(Authentication authentication) {
        ...
        // I6 is the merged i18n-and-learning read page. Once either read authority
        // grants access to this endpoint, all overview fields are one authoritative
        // global catalog; hiding the course metadata produces a malformed 200 for
        // I6-only operators and makes the PC client correctly fail closed.
