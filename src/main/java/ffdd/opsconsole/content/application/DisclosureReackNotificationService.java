...
public class DisclosureReackNotificationService {
    ...
    public int notifyPublished(
            String jurisdiction, String version, List<String> countryCodes, String activationKey, LocalDateTime now) {
        if (!StringUtils.hasText(jurisdiction) || !StringUtils.hasText(version)
