...
public interface AppDeveloperAccessMapper extends BaseMapper<Object> {
    ...
    record AccessRow(String requestNo, Long userId, String idempotencyKey, String requestHash, String status, String reviewReason,
