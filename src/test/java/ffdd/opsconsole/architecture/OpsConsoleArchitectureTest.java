...
class OpsConsoleArchitectureTest {
    ...
    void applicationUsesSingleBootAppAndMybatisMapperScan() {
        ...
        MapperScan[] mapperScans = NexionOpsConsoleApplication.class.getAnnotationsByType(MapperScan.class);

        assertThat(mapperScans)
                .anySatisfy(scan -> assertThat(scan.value()).containsExactly("ffdd.opsconsole.**.mapper"));
    }
