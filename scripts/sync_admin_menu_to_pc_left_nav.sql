...
VALUES
  ...
  (1306, 'MENU_FINANCE_D6', '汇率牌价', '汇率牌价', 'D6', 1300, '/finance/fx-rate', 'Document', 1306, 'D6 汇率牌价,按PC左侧菜单同步。', 1, 0),
