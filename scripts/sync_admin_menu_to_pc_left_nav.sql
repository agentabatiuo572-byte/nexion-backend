...
VALUES
  ...
  (1401, 'MENU_DEVICES_E1', '商品目录 & 代际门', '商品目录 & 代际门', 'E1', 1400, '/devices/pricing', 'Document', 1401, 'E1 商品目录 & 代际门,按PC左侧菜单同步。', 1, 0),
  ...
  (1805, 'MENU_CONTENT_I5', '风险披露版本', '风险披露版本', 'I5', 1800, '/content/disclosure', 'Document', 1805, 'I5 风险披露版本,按PC左侧菜单同步。', 1, 0),
