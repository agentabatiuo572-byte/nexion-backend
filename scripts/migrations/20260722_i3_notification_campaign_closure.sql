...
VALUES
  ...
  ('high', '50 条', '每用户保留最新 50 条高优通知，超出部分淘汰最旧记录（按创建时间从早到晚）', 0, 20, 1, 'migration:i3-closure', NOW(), NOW(), 0),
  ('normal', '200 条', '每用户保留最新 200 条常规通知，超出部分淘汰最旧记录（按创建时间从早到晚）', 0, 30, 1, 'migration:i3-closure', NOW(), NOW(), 0),
...
UPDATE nx_notification_cap_rule
   SET cap_label='50 条',
       policy='每用户保留最新 50 条高优通知，超出部分淘汰最旧记录（按创建时间从早到晚）',
...
UPDATE nx_notification_cap_rule
   SET cap_label='200 条',
       policy='每用户保留最新 200 条常规通知，超出部分淘汰最旧记录（按创建时间从早到晚）',
