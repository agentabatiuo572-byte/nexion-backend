...
-- switch already exists, BEP20 starts with the same value. If the historical
-- key is absent, fail closed until an authorized D5 operator enables BEP20.
-- Metadata repair preserves later operator changes.
