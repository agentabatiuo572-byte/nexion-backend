...
VALUES
    ('welcome', '欢迎模板', '/earn', 'v1',
     '欢迎来到 NexGrid', '从第一项收益任务开始了解平台。',
     'Chào mừng đến NexGrid', 'Hãy bắt đầu với nhiệm vụ thu nhập đầu tiên.',
    ...
    ('social', '真实业务动态模板', 'NONE', 'v1',
     ...
     'Hoạt động thực trên NexGrid', '{actor} tại {city} vừa hoàn tất {amount}',
     'Verified NexGrid activity', '{actor} in {city} completed {amount}',
     'PUBLISHED', 'system:migration', 'I2 canonical localized template', NOW(), NOW(), 0),
    ...
    ('wrapped', '周期回顾模板', '/me/weekly', 'v1',
     '你的 NexGrid 回顾', '回顾这一周期的设备、收益和任务成果。',
     'Nhìn lại hành trình NexGrid', 'Xem lại thiết bị, thu nhập và thành tích nhiệm vụ của bạn.',
     'Your NexGrid recap', 'Review your devices, earnings, and task achievements.',
     'PUBLISHED', 'system:migration', 'I2 canonical localized template', NOW(), NOW(), 0),
