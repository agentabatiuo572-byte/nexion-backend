...
$migrations = @(
  ...
  (Join-Path $root "scripts\migrations\20260914_wallet_reconciliation_read_index.sql"),
  (Join-Path $root "scripts\migrations\20260914_task_assignment_active_read_index.sql"),
