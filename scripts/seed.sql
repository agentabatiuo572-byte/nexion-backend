...
VALUES
  ...
  (130, 'MENU_COMMERCE', 'Commerce', NULL, '/commerce', 'ShoppingCart', 130, 'Commerce operations group.', 1),
  (131, 'MENU_COMMERCE_PRODUCTS', 'Product SKU', 130, '/commerce/products', 'Goods', 131, 'Product SKU configuration.', 1),
  (132, 'MENU_COMMERCE_ORDERS', 'Orders', 130, '/commerce/orders', 'Tickets', 132, 'Commerce order operations.', 1),
  (133, 'MENU_COMMERCE_PAYMENTS', 'Payment Reconcile', 130, '/commerce/payments', 'CreditCard', 133, 'Payment and reconciliation operations.', 1),
  (134, 'MENU_COMMERCE_TRADEINS', 'Trade-in', 130, '/commerce/tradeins', 'Refresh', 134, 'Trade-in applications.', 1),
  (150, 'MENU_GENESIS', 'Genesis', NULL, '/genesis', 'Star', 150, 'Genesis operations group.', 1),
  (151, 'MENU_GENESIS_SERIES', 'Genesis Series', 150, '/genesis/series', 'Collection', 151, 'Genesis series configuration.', 1),
  (152, 'MENU_GENESIS_ORDERS', 'Genesis Orders', 150, '/genesis/orders', 'Tickets', 152, 'Genesis order operations.', 1),
  (153, 'MENU_GENESIS_HOLDINGS', 'Genesis Holdings', 150, '/genesis/holdings', 'Medal', 153, 'Genesis holding operations.', 1),
  (160, 'MENU_COMPUTE', 'Compute', NULL, '/compute', 'Cpu', 160, 'Compute operations group.', 1),
  (161, 'MENU_COMPUTE_DEVICES', 'Devices', 160, '/compute/devices', 'Cpu', 161, 'Device instances.', 1),
  (162, 'MENU_COMPUTE_LIFECYCLE', 'Lifecycle', 160, '/compute/lifecycle', 'Timer', 162, 'Device lifecycle rules.', 1),
  (163, 'MENU_COMPUTE_TASKS', 'Compute Tasks', 160, '/compute/tasks', 'Operation', 163, 'Compute task queue.', 1),
  (164, 'MENU_COMPUTE_RECEIPTS', 'Receipts', 160, '/compute/receipts', 'DocumentChecked', 164, 'Proof-of-Compute receipts.', 1),
  (165, 'MENU_COMPUTE_NODE_MAP', 'Node Map', 160, '/compute/node-map', 'MapLocation', 165, 'Compute node map.', 1),
  (170, 'MENU_WALLET', 'Wallet', NULL, '/wallet', 'Wallet', 170, 'Wallet operations group.', 1),
  (171, 'MENU_WALLET_OVERVIEW', 'Wallet Overview', 170, '/wallet/overview', 'Wallet', 171, 'Wallet overview.', 1),
  (172, 'MENU_WALLET_LEDGERS', 'Wallet Ledgers', 170, '/wallet/ledgers', 'Tickets', 172, 'Wallet ledgers.', 1),
  (173, 'MENU_WALLET_DEPOSITS', 'Deposits', 170, '/wallet/deposits', 'Download', 173, 'Deposit operations.', 1),
  (174, 'MENU_WALLET_WITHDRAWALS', 'Withdrawals', 170, '/wallet/withdrawals', 'Upload', 174, 'Withdrawal broadcast operations.', 1),
  (180, 'MENU_COMPLIANCE', 'Compliance', NULL, '/compliance', 'Checked', 180, 'Compliance and risk operations group.', 1),
  (181, 'MENU_COMPLIANCE_KYC', 'KYC', 180, '/compliance/kyc', 'UserFilled', 181, 'KYC operations.', 1),
  (182, 'MENU_COMPLIANCE_RISK', 'Risk Decisions', 180, '/compliance/risk-decisions', 'DataAnalysis', 182, 'Risk decision operations.', 1),
  (183, 'MENU_COMPLIANCE_REVIEW', 'Manual Review', 180, '/compliance/review', 'Warning', 183, 'Manual risk review queue.', 1),
  (184, 'MENU_COMPLIANCE_BLACKLISTS', 'Blacklists', 180, '/compliance/blacklists', 'CircleClose', 184, 'Blacklist operations.', 1),
  (185, 'MENU_COMPLIANCE_PROOF', 'Proof Assets', 180, '/compliance/proof-assets', 'Files', 185, 'Proof asset review.', 1),
  (190, 'MENU_SYSTEM', 'System Config', NULL, '/system', 'Setting', 190, 'System operations group.', 1),
  (191, 'MENU_SYSTEM_CONFIGS', 'Admin Config', 190, '/system/configs', 'Setting', 191, 'Admin configuration.', 1),
  (192, 'MENU_SYSTEM_PUBLIC_CONFIG', 'Public Config', 190, '/system/public-config', 'View', 192, 'Public configuration.', 1),
  (193, 'MENU_SYSTEM_I18N', 'I18n', 190, '/system/i18n', 'ChatLineSquare', 193, 'I18n messages.', 1),
  (194, 'MENU_SYSTEM_CONTENT', 'Content Pages', 190, '/system/content', 'Document', 194, 'Content pages.', 1),
  (195, 'MENU_SYSTEM_HELP', 'Help Center', 190, '/system/help', 'QuestionFilled', 195, 'Help center articles.', 1),
  (196, 'MENU_SYSTEM_SUPPORT_TICKETS', 'Support Tickets', 190, '/system/support-tickets', 'Service', 196, 'Support ticket operations.', 1),
  (210, 'MENU_OPENAPI', 'OpenAPI', NULL, '/openapi', 'Connection', 210, 'OpenAPI operations group.', 1),
  (211, 'MENU_OPENAPI_APPS', 'OpenAPI Apps', 210, '/openapi/apps', 'Key', 211, 'OpenAPI app operations.', 1),
  (212, 'MENU_OPENAPI_CALL_AUDITS', 'Call Audits', 210, '/openapi/call-audits', 'DataLine', 212, 'OpenAPI call audits.', 1),
  (213, 'MENU_OPENAPI_WEBHOOKS', 'Webhooks', 210, '/openapi/webhooks', 'Position', 213, 'Webhook delivery operations.', 1),
  (220, 'MENU_AUDIT', 'Audit', NULL, '/audit', 'DataLine', 220, 'Audit operations group.', 1),
  (221, 'MENU_AUDIT_LOGS', 'Audit Logs', 220, '/audit/logs', 'Document', 221, 'Audit log query.', 1),
  (222, 'MENU_AUDIT_STATS', 'Audit Stats', 220, '/audit/stats', 'DataAnalysis', 222, 'Audit statistics.', 1),
  ...
  (243, 'MENU_NOTIFICATION_CONSUMER', 'Notification Consumer Events', 240, '/notification/consumer', 'Connection', 243, 'Notification consumer delivery operations.', 1)
ON DUPLICATE KEY UPDATE
...
SELECT 2, id FROM admin_menu WHERE menu_code IN (
  ...
  'MENU_COMMERCE_PAYMENTS',
  'MENU_COMMERCE_TRADEINS',
  'MENU_GENESIS',
  'MENU_GENESIS_SERIES',
  'MENU_GENESIS_ORDERS',
  'MENU_GENESIS_HOLDINGS',
  'MENU_COMPUTE',
  'MENU_COMPUTE_DEVICES',
  'MENU_COMPUTE_LIFECYCLE',
  'MENU_COMPUTE_TASKS',
  'MENU_COMPUTE_RECEIPTS',
  'MENU_COMPUTE_NODE_MAP',
  'MENU_WALLET',
  'MENU_WALLET_OVERVIEW',
  'MENU_WALLET_LEDGERS',
  'MENU_WALLET_DEPOSITS',
  'MENU_WALLET_WITHDRAWALS',
  'MENU_COMPLIANCE',
  'MENU_COMPLIANCE_KYC',
  'MENU_COMPLIANCE_RISK',
  'MENU_COMPLIANCE_REVIEW',
  'MENU_COMPLIANCE_BLACKLISTS',
  'MENU_COMPLIANCE_PROOF',
  'MENU_SYSTEM',
  'MENU_SYSTEM_CONFIGS',
  'MENU_SYSTEM_PUBLIC_CONFIG',
  'MENU_SYSTEM_I18N',
  'MENU_SYSTEM_CONTENT',
  'MENU_SYSTEM_HELP',
  'MENU_SYSTEM_SUPPORT_TICKETS',
  'MENU_OPENAPI',
  'MENU_OPENAPI_APPS',
  'MENU_OPENAPI_CALL_AUDITS',
  'MENU_OPENAPI_WEBHOOKS',
  'MENU_AUDIT',
  'MENU_AUDIT_LOGS',
  'MENU_AUDIT_STATS',
  'MENU_MISSION',
