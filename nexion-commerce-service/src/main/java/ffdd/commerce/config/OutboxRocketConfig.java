...
public class OutboxRocketConfig {
    ...
    public DefaultMQProducer outboxRocketProducer(
            @Value("${nexion.outbox.rocketmq.name-server:127.0.0.1:9876}") String nameServer,
            @Value("${nexion.outbox.rocketmq.producer-group:nexion-commerce-outbox}") String producerGroup) {
