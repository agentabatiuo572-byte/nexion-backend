package ffdd.commerce.client.config;
...
public class ComplianceFeignConfig {
    @Bean
    public RequestInterceptor commerceComplianceAuthInterceptor(
        ...
        return template -> {
            ...
            template.header(AuthHeaders.USERNAME, "nexion-commerce-service");
            template.header(AuthHeaders.AUTHORITIES, "PERM_COMPLIANCE_WRITE");
        };
    }
}
